...
def deszifratu2(mezua):
    
    letrak=Counter(mezua)
    print('Letra kopurua: ' + str(letrak))
 
    des_table = mezua.maketrans('XETARNCJDZPKIHUSGFQOMV','EALDCSINPUMROTGQJXBFHY')
    des_mezua = mezua.translate(des_table)
    print(des_mezua)
